...
const Verification = () => {
  ...
  return (
    ...
    >
      <div className="md:w-[40%] w-[90%] h-[70%] bg-white rounded-3xl drop-shadow-lg shadow-black flex justify-center items-center">
    <div className="md:w-[80%] w-[100%] h-[80%] flex justify-evenly items-center flex-col">
            <h2 className="text-xl text-center">
              We send a verification code to{" "}
              <span>{email}</span>
            </h2>
            <div className="w-[90%] h-14  flex justify-center items-center lg:gap-4 md:gap-2 gap-1">
              {code.map((num, index) => (
                <input
                  key={index}
                  type="text"
