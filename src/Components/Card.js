...
const Card = ({rate = 0, id, name, company, price, product, img}) => {
...
<div className='w-72 h-96 bg-white border-4 rounded flex justify-center items-center flex-col text-black'>
    ...
    <p className='w-[80%] h-[10%] text-lg m-0 flex justify-start items-center gap-3'>{price}$ 
      {/* <span className='py-0.5 px-2 font-normal rounded-md bg-[#074da6] text-white text-xs'>Save 10%</span> */}
      </p>
    <div className="w-[80%] h-[10%] flex justify-start items-center">
      ...
      <p className='text-center ml-2 my-auto'>{rate}</p>
    </div>
